...
export const WithInitials = () => <Avatar letter="AM" />;
export const WithName = () => <Avatar name="John Doe"  letter={'JD'}/>;
export const WithCustomClass = () => <Avatar letter="S" className="custom-class" />;
