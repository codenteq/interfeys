...
export default function Card({ className, link, button, children, }: ICardProps): ReactNode {
...
export const WithInitials = () => <Card link={{ href: '#', name: 'Link' }} > Lorem Ipsum </Card>;
export const WithName = () => <Card> Lorem Ipsum </Card>;
export const WithCustomClass = () => <Card className="custom-class" > Lorem Ipsum </Card>;
